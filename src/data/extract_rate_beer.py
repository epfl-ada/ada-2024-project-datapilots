...
# Path to the ratings.txt.gz file inside the RateBeer folder
ratings_gz_path = os.path.join(rate_beer_extract_dir, "ratings.txt.gz")
ratings_txt_path = os.path.join(rate_beer_extract_dir, "ratings.txt")
